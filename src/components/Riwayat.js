...
import { formatRupiah, hitungKeuntungan, isToday } from '../utils/helpers'
...
export default function Riwayat({ transaksi, produk, onLihatDetail, onHapus }) {
  ...
  // hitung total keuntungan dari transaksi yang ditampilkan
                ...
                <tr key={transaksi.id} className="hover:bg-gray-50 dark:bg-gray-900/50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      <button
                        onClick={() => onLihatDetail(transaksi)}
