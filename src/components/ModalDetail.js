...
// Modal detail dibikin Ellen
// Bantuan itungan dr Joan
...
// itung cuan (joan)
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 w-full max-w-lg square p-6">
        ...
        <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {(() => {
                      ...
                      return produkItem?.kategori ? (
                        <p className="text-xs text-gray-400 mt-1">{produkItem.kategori}</p>
                      ) : null
                    })()}
                  </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 p-4 square mt-6">
            <div className="flex justify-between items-center mb-2">
              <span className="text-gray-600">Total Bayar</span>
              <span className="text-xl font-bold text-primary">{formatRupiah(transaksi.total)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Laba</span>
              <span className="font-semibold text-green-600">{formatRupiah(totalKeuntungan)}</span>
            </div>
          </div>
        </div>

        <div className="mt-6">
          <button onClick={onClose} className="w-full bg-gray-100 dark:bg-gray-800 text-gray-700 py-2 square hover:bg-gray-200">
            Tutup
          </button>
        </div>
      </div>
