            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-1">{item.kategori}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="bg-gray-100 p-1 square"
                    >
                      <Minus size={16} />
                    </button>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              disabled={keranjang.length === 0}
              className="w-full bg-gray-100 text-gray-700 py-2 square hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Kosongkan Keranjang
            </button>
          </div>
